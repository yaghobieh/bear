...
export const NAVIGATION: NavGroup[] = [
  {
    ...
    items: [
      ...
      { path: '/whats-new', label: "What's New", badge: 'New' },
      { path: '/installation', label: 'Installation' },
      { path: '/changelog', label: 'Changelog' },
      { path: '/skills', label: 'Skills', badge: 'New' },
      { path: '/docs/forms', label: 'Forms' },
      { path: '/docs/cli', label: 'CLI' },
      { path: '/docs/package-imports', label: 'Package Imports' },
      { path: '/theming', label: 'Theming' },
      { path: '/docs/dark-mode', label: 'Dark Mode' },
      { path: '/docs/javascript', label: 'JavaScript' },
      { path: '/docs/nextjs', label: 'Next.js' },
      { path: '/typescript', label: 'TypeScript' },
      { path: '/icons', label: 'Icons', badge: 'icons' },
      { path: '/docs/directory', label: 'Registry Directory' },
    ...
    items: [
      // Layout
      {
        ...
        children: [
          ...
          { path: '/components/aspect-ratio', label: 'AspectRatio' },
        ],
      },
      // Page Layout
      {
      ...
      // Input
      {
        ...
        children: [
          ...
          { path: '/components/form-field', label: 'FormField' },
          { path: '/components/form-control', label: 'FormControl', badge: 'New' },
          { path: '/components/password-input', label: 'PasswordInput' },
          { path: '/components/input-group', label: 'InputGroup' },
          ...
          { path: '/components/currency-input', label: 'CurrencyInput' },
      ...
      // Form Controls
      {
        ...
        children: [
          ...
          { path: '/components/checkbox-card', label: 'CheckboxCard' },
          { path: '/components/radio', label: 'Radio' },
          { path: '/components/radio-card', label: 'RadioCard' },
      ...
      // Pickers
      {
        ...
        children: [
          ...
          { path: '/components/date-range-picker', label: 'DateRangePicker' },
          { path: '/components/time-picker', label: 'TimePicker' },
          { path: '/components/color-picker', label: 'ColorPicker' },
          { path: '/components/color-swatch', label: 'ColorSwatch' },
      ...
      // Card
      {
        ...
        children: [
          ...
          { path: '/components/hover-card', label: 'Hover Card' },
          { path: '/components/glow-card', label: 'GlowCard' },
        ],
      },
      // Overlay
      {
      ...
      // Navigation
      {
        ...
        children: [
          ...
          { path: '/components/page-nav', label: 'PageNav' },
        ],
      },
      // Typography
      {
        ...
        children: [
          ...
          { path: '/components/blockquote', label: 'Blockquote' },
          { path: '/components/spoiler', label: 'Spoiler' },
      ...
      // Data
      {
        ...
        children: [
          ...
          { path: '/components/infinite-scroll', label: 'InfiniteScroll' },
    ...
    items: [
      {
        ...
        children: [
          ...
          { path: '/components/media-player', label: 'MediaPlayer' },
          { path: '/components/image-annotation', label: 'ImageAnnotation' },
      ...
      },
      {
        ...
        children: [
          ...
          { path: '/components/animated-counter', label: 'AnimatedCounter' },
      ...
      },
      {
        ...
        children: [
          ...
          { path: '/components/overlay', label: 'Overlay' },
      ...
      },
      {
        ...
        children: [
          ...
          { path: '/components/diff-squares', label: 'DiffSquares' },
          { path: '/components/terminal', label: 'Terminal' },
          { path: '/components/props-playground', label: 'PropsPlayground' },
        ],
      },
      {
  ...
  // Charts
  {
    ...
    items: [
      ...
      { path: '/components/timeline-chart', label: 'TimelineChart' },
      { path: '/components/tag-cloud', label: 'TagCloud' },
    ],
  },
    ...
    items: [
      { path: '/api/overview', label: 'Overview' },
      {
        ...
        children: [
          ...
          { path: '/api/form-field', label: 'FormField API' },
          { path: '/api/password-input', label: 'PasswordInput API' },
      ...
      },
      {
        ...
        children: [
          ...
          { path: '/api/alert-dialog', label: 'AlertDialog API' },
        ],
      },
    ],
  },
  ...
  // Hooks
  {
    ...
    items: [
      ...
      { path: '/hooks/use-media-query', label: 'useMediaQuery' },
