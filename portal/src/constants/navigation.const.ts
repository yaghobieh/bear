...
export const BEAR_VERSION = '1.2.3';
...
export const NAVIGATION: NavGroup[] = [
    ...
    items: [
      ...
      // Input
      {
        ...
        children: [
          ...
          { path: '/components/currency-input', label: 'CurrencyInput', badge: '1.2.3' },
      ...
      // Card
      {
        ...
        children: [
          ...
          { path: '/components/glow-card', label: 'GlowCard', badge: '1.2.3' },
        ],
      },
      // Overlay
      {
    ...
    items: [
      {
        ...
        children: [
          ...
          { path: '/components/media-player', label: 'MediaPlayer', badge: '1.2.3' },
          { path: '/components/image-annotation', label: 'ImageAnnotation', badge: '1.2.3' },
      ...
      },
      {
        ...
        children: [
          ...
          { path: '/components/animated-counter', label: 'AnimatedCounter', badge: '1.2.3' },
  ...
  // Charts
  {
    ...
    items: [
      ...
      { path: '/components/heatmap', label: 'Heatmap', badge: '1.2.3' },
      { path: '/components/timeline-chart', label: 'TimelineChart', badge: '1.2.3' },
      { path: '/components/tag-cloud', label: 'TagCloud', badge: '1.2.3' },
    ],
  },
