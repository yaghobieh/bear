...
const DIAL_MODE_ACTIVE = 'bear-text-primary-600 dark:bear-text-primary-400 bear-font-bold bear-bg-primary-50 dark:bear-bg-primary-900/30 bear-rounded bear-px-1';
            ...
            {(['AM', 'PM'] as const).map((p) => (
              <button
                ...
                className={cn(
                  ...
                  period === p
                    ? 'bear-text-primary-600 dark:bear-text-primary-400 bear-font-medium'
