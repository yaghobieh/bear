      ...
      >
        {showHandle && (
          <div className="bear-flex bear-justify-center bear-pt-2 bear-pb-1">
            <div className="bear-w-12 bear-h-1 bear-rounded-full bear-bg-zinc-600" aria-hidden />
          </div>
        )}

        {(title || showCloseButton) && (
          <div className="bear-flex bear-items-center bear-justify-between bear-px-4 bear-py-3 bear-border-b bear-border-zinc-700">
            {title && (
              <h2
        ...
        <div className="bear-flex-1 bear-overflow-y-auto bear-p-4 bear-text-zinc-300">
          {children}
        </div>
      </div>
    </div>
