...
export const ROOT_CLASS =
  'Bear-RadioCard bear-relative bear-rounded-lg bear-transition-all bear-duration-200 bear-cursor-pointer bear-text-left';

export const RADIO_INDICATOR_SIZE_MAP: Record<'sm' | 'md' | 'lg', string> = {
