...
export const LIGHT_CHECK_CLASSES = 'bear-text-gray-800';

export const GROUP_CLASSES = 'Bear-ColorSwatchGroup bear-flex bear-flex-wrap';
export const LABEL_CLASSES = 'bear-block bear-text-[10px] bear-text-center bear-mt-1 bear-text-gray-500 dark:bear-text-zinc-400 bear-truncate';

export const LIGHT_THRESHOLD = 200;
