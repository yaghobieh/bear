        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tr><td className="px-4 py-3 font-mono text-bear-600">lockBodyScroll</td><td className="px-4 py-3 text-gray-600 dark:text-gray-400"><code>boolean</code></td><td className="px-4 py-3 text-gray-600 dark:text-gray-400">true</td><td className="px-4 py-3 text-gray-600 dark:text-gray-400">Prevent page scroll while open</td></tr>
              <tr><td className="px-4 py-3 font-mono text-bear-600">cancelPreventScroll</td><td className="px-4 py-3 text-gray-600 dark:text-gray-400"><code>boolean</code></td><td className="px-4 py-3 text-gray-600 dark:text-gray-400">false</td><td className="px-4 py-3 text-gray-600 dark:text-gray-400">When true, page stays scrollable</td></tr>
              <tr><td className="px-4 py-3 font-mono text-bear-600">isCancelBackgroundClick</td><td className="px-4 py-3 text-gray-600 dark:text-gray-400"><code>boolean</code></td><td className="px-4 py-3 text-gray-600 dark:text-gray-400">—</td><td className="px-4 py-3 text-gray-600 dark:text-gray-400">If set, toggles backdrop close (overrides closeOnBackdrop)</td></tr>
            </tbody>
          </table>
        </div>
      </section>
