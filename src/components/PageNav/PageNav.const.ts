...
export const VARIANT_CLASSES = {
  default: {
    link: 'bear-text-zinc-400 hover:bear-text-primary-400 bear-transition-colors',
    label: 'bear-text-zinc-500',
    icon: 'bear-text-primary-500',
  },
  outlined: {
    link: 'bear-border bear-border-zinc-700 bear-rounded-lg hover:bear-border-primary-500 hover:bear-text-primary-400 bear-transition-all',
    label: 'bear-text-zinc-500',
    icon: 'bear-text-primary-500',
  },
  filled: {
    link: 'bear-bg-zinc-800/50 bear-rounded-lg hover:bear-bg-primary-500/10 hover:bear-text-primary-400 bear-transition-all',
    label: 'bear-text-zinc-500',
    icon: 'bear-text-primary-500',
  },
};
